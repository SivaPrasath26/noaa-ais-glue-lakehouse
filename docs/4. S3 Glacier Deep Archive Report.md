...
| Data Layer             | Format  | Total Size (GB) | Reduction vs Previous Layer |
| ---------------------- | ------- | --------------- | --------------------------- |
| Raw Data               | CSV     | 425.45          | —                           |
| Cleaned / Staging Data | Parquet | 101.11          | **76.23% smaller**          |

**Compression Ratio:** ~4.2× reduction from CSV to Parquet.

**Key Insight:** The Parquet layer provides efficient columnar storage with compression and encoding optimizations, cutting raw storage volume by over three-quarters.
...
* Screenshot shows CloudShell command execution confirming Glacier Deep Archive transition.
